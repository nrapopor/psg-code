...
/* Help & Reference: http://projectsentrygun.rudolphlabs.com/make-your-own
 ...
 attach USB indicator LED to 				digital I/O		pin 11
 ...
 attach disable plate momentary button to 	digital I/O 	pin 2 	(low-active: when on, connects pin to GND)
...
void sequenceLEDs(int repeats, unsigned long delayTime) {
